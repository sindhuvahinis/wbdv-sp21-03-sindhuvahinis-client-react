            ...
            <div className="row ss-sticky-header">
                <div className="col-4 ss-module-col ss-brand-title-header">
                    <span className="ss-cancel-icon">
                        <i onClick={() => props.history.goBack()} className="fas fa-window-close fa-lg"/>
                    </span>
                ...
                <div className="col-8">
                    <ul className="nav nav-pills ss-nav-pills">
                        <li className="nav-item">
                            <a className="nav-link ss-link" aria-current="page" href="#">Build</a>
                        </li>
                        <li className="nav-item">
                    ...
                    <ul className="list-group ss-module-list-group">
                        <li className="list-group-item ss-module-list-group-item">
                            <div className="ss-module-link">
                                <a href="#" className="ss-module-name ss-link">Module 1 - jQuery</a>
                        ...
                        <li className="list-group-item active ss-module-list-group-item">
                            <div className="ss-module-link active">
                                <a href="#" className="ss-module-name ss-link">Module 2 - React</a>
                                <a href="#" className="ss-module-delete-icon-link ss-link">
                                    <i className="fa-pull-right fas fa-trash ss-module-delete-icon"/>
                                </a>
                            </div>
                        ...
                        <li className="list-group-item ss-module-list-group-item">
                            <div className="ss-module-link">
                                <a href="#" className="ss-module-name ss-link">Module 3 - Redux</a>
                                <a href="#" className="ss-module-delete-icon-link ss-link">
                                    <i className="fa-pull-right fas fa-trash ss-module-delete-icon"/>
                                </a>
                            </div>
                        ...
                        <li className="list-group-item ss-module-list-group-item">
                            <div className="ss-module-link">
                                <a href="#" className="ss-module-name ss-link">Module 4 - Native</a>
                                <a href="#" className="ss-module-delete-icon-link ss-link">
                                    <i className="fa-pull-right fas fa-trash ss-module-delete-icon"/>
                                </a>
                            </div>
                        ...
                        <li className="list-group-item ss-module-list-group-item">
                            <div className="ss-module-link">
                                <a href="#" className="ss-module-name ss-link">Module 6 - Node</a>
                                <a href="#" className="ss-module-delete-icon-link ss-link">
                                    <i className="fa-pull-right fas fa-trash ss-module-delete-icon"/>
                                </a>
                            </div>
                        ...
                        <li className="list-group-item ss-module-list-group-item">
                            <div className="ss-module-link">
                                <a href="#" className="ss-module-name ss-link">Module 7 - Mongo</a>
                                <a href="#" className="ss-module-delete-icon-link ss-link">
                                    <i className="fa-pull-right fas fa-trash ss-module-delete-icon"/>
                                </a>
                            </div>
